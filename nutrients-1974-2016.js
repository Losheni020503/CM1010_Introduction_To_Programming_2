    ...
    this.draw = function() {
        ...
        //draw x and y axis labels
         drawAxisLabels(this.xAxisLabel,
                        this.yAxisLabel,
                        this.layout); 
        //plot all the nutrients between start and end year using the width of canvas minus the margin
        var numYears = this.endYear - this.startYear;
            
        
        //loop all over the rows and draw the line from the previous and current value   
            ...
            //draw the x ticks that is the year
