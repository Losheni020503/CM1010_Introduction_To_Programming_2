...
//      console.log(this.mapTemperatureToColour(current.temperature).levels)
    
//         rect(this.mapYearToWidth(current.year),this.layout.topMargin,segmentWidth,this.layout.plotHeight);
